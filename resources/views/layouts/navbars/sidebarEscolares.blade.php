                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('verUsuarios') }}" >
                            <i class="fas fa-users text-danger" style= "color: danger"></i>{{ __('Usuarios') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agregarCoordinador') }}">
                            <i class="fas fa-user-edit text-green"></i> {{ __('Agregar Usuario') }}
                        </a>
                    </li>
                    <li class="nav-item">
