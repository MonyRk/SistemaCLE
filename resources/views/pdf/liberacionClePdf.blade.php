...
@php
    ...
    @endphp
<p align="justify">Por este conducto, los que suscriben, integrantes del Jurado para el proceso 
    ...
    {{ $datosEstudiante[0]->carrera }} con clave del plan de estudios {{ $plan }} acredit&oacute; 
    por curso de Ingl&eacute;s nivel {{ $nivel }} en la Coordinaci&oacute;n de Lenguas Extranjeras con 
    n&uacute;mero de registro TecNM-SEV-DECyaD-PCLE-01/18-ITO-32.</p>
