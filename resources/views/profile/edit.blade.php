                    ...
                    <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    ...
                                    <div>
                                        ...
                                        <span class="description">{{ __('Fotos') }}</span>
                                    </div>
                                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Oaxaca, México') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Coordinador de Lenguas Extranjeras') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Universidad Autonoma Benito Juarez de Oaxaca') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('Aqui ira una breve descripcion') }}</p>
