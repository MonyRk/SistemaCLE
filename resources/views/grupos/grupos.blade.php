                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush th">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                           <a href="{{ route('verInfoGrupo',$grupo->id_grupo) }}"> {{ $grupo->grupo }}</a>
                                        </th>
                                        <th>
                                        ...
                                        <td>
                                            <a href="" id="grupoid" data-grupoid="{{ $grupo->id_grupo }}" data-toggle="modal" data-target="#modal-notification" ><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
