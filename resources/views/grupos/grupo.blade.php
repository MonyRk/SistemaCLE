            ...
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-md">
                        ...
                        <input type="text" name="name" id="input-name" class="form-control" value="{{ old('name',$data['name']) }}" >
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md">
                        ...
                        <input type="text" name="cupo" id="input-cupo" class="form-control" placeholder="" value="{{ old('cupo',$data['cupo']) }}" >
                    </div>
                    <div class="form-group col-md">
